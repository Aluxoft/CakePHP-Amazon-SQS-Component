            ...
            if (is_array($fieldType)) {
                if ($this->_isComplexType($fieldType[0])) {
                    ...
                    if ($elements->length >= 1) {
                        require_once (VENDORS . 'amazon_sqs' . DS . str_replace('_', DIRECTORY_SEPARATOR, $fieldType[0]) . ".php");
                ...
                if ($this->_isComplexType($fieldType)) {
                    $elements = $xpath->query("./a:$fieldName", $dom);
                    if ($elements->length == 1) {
                        require_once (VENDORS . 'amazon_sqs' . DS . str_replace('_', DIRECTORY_SEPARATOR, $fieldType) . ".php");
